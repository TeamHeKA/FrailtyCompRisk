test_that("Ml_CompRisk does not work without covariables.", {
  ...
  expect_error(Ml_CompRisk(df),"With no covariables, there is nothing to estimate")
})

test_that("Ml_CompRisk works in a typical case.",{
  set.seed(123)
