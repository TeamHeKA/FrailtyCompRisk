...
M = Multi_tests(N_test = 200,n_cov = 8,n_cluster = 20,n_per_cluster = 100,a1 = 0,b1 = 1)
...
big_table <- generate_full_table(
  beta_vec = list(a=c(1,0.2),b=c(-0.2,0,0.4,-0.5),d=c(0.3,0.7,-0.15,-0.45,0.3,-0.5)), theta_vec = c(0, 0.1, 0.6), N_vec = c(200, 500), K_vec = c(5, 20), n_sim = 200, pcens = 0.25
)

View(big_table$final_df)
...
```{r}
export_to_latex(big_table$final_df,"simulation_results_3.tex")
```
