...
M = Multi_tests(N_test = 20,n_cov = 8,n_cluster = 15, n_per_cluster = 20,a1 = 0,b1 = 1)
...
#big_table <- generate_full_table(beta_vec = list(a=c(0),b=c(0.375)), theta_vec = c(0, 0.1, 0.6), N_vec = c(200, 500), K_vec = c(5, 20), n_sim = 100, pcens = 0.25)
